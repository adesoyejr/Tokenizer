...
<div class="container">
  ...
  <div class="jumbotron">
    ...
    <p><?php echo $data['FirstName']." " .$data['LastName'] ;?> Deposit</p>
  </div>
  </center>
</div>
<br><hr><br>
...
<div class="container">
  <center class="animated bounceInDown">
    <div class="jumbotron">
        <form role="form" action="depaction.php" method="POST">
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-6">
                    <label>Name of Depositor</label>
                    <input required style="color:black" type="text" class="form-control" id="depositor" name="depositor" placeholder="Enter the name of the depositor">
                    <br>

                    <label>Amount to be Deposited</label>
                    <input required style="color:black" type="text" class="form-control" id="amount" name="amount" placeholder="Enter the amount to be payed in">

                    <br><br>
                    <button type="submit" onclick="checkuser(this.value)" name="submit" class="btn btn-success">Confirm Deposit</button>
                    </form>
