// AJAX Framework Version 2.5
// Copyright 2008 Jason Graves (GodLikeMouse)
...
// Supported Browsers: IE 6.0+, Opera 8+, Safari, Mozilla based browsers 
...
GLM.AJAX = function(){
    ...
    /// }
    ///
    /// ajax.callService("http://myserver.com/myService.asmx", "myMethod", ajaxCallback); //call myService.asmx and pass the contents to ajaxCallback.</example>
