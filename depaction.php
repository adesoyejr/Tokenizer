...
{        
    ...
    $newDeposit = new account($conn);
    $Deposit = $newDeposit->doDeposit($AccountNumber, $Amount, $Depositor, $balance);
    ...
    if($Deposit)
    {
        ...
        <div class='col-lg-12'>
            ...
            <center><h5 style='color:white'>Deposit done successfully</h5></center>
            </div>
        </div>
        ";
    }else
